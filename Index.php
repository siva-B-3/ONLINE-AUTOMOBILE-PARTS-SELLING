...
<html lang="en">
    ...
    <body>		
				...
				<div class="span8">
					<div class="account pull-right">
						<ul class="user-menu">				
							...
							<li><a href="Admin/index1.php">my link</a> 
						</ul>
					</div>
				</div>
			</div>
		...
		<div id="wrapper" class="container">
			<section class="navbar main-menu">
				<div class="navbar-inner main-menu">				
					<a href="index.php" class="logo pull-left"><div style="padding-bottom:2px; font-size:24px;padding-top:2px;"><strong>Online Automobile car Parts Shopping </strong></div>  </a>
			...
			<section  class="homepage-slider" id="home-slider">
				<div class="flexslider">
					<ul class="slides">
						<li>
							<img src="new images/a.jpg" height="400px" width="1000px" />
						</li>
                        <li>
							<img src="new images/front.jpg" alt="" />
						</li>
						<li>
							<img src="new images/USD.jpg" alt="" />
							<div class="intro">
								<h1></h1>
								<p><span></span></p>
								<p><span></span></p>
			...
			<section class="header_text">
				We stand for top quality Products. Our genuine dealer always Provide Good and Qualit Products. 
				<br/>Don't miss to Buy our cheap and best Products Here.
			</section>
  	  ...
  	  <div class="form-group">
                                            ...
                                            <select class="form-control" name="fvalue">
                                            <?php
												include"config.php";
									...
									<div class="carousel-inner">
										<div class="active item">
                                         ...
                                         <?php
											...
											$select_our_products=mysql_query("select * from product_tb") or die(mysql_error());
